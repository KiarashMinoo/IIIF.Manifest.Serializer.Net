...
public class TextGranularity : ValuableItem<TextGranularity>
{
    ...
    /// </summary>
    public static readonly TextGranularity Page = new("page");

    /// <summary>
    ///     An arbitrary region of text.
    /// </summary>
    public static readonly TextGranularity Block = new("block");

    /// <summary>
    ///     A paragraph.
    /// </summary>
    public static readonly TextGranularity Paragraph = new("paragraph");

    /// <summary>
    ///     A topographic line.
    /// </summary>
    public static readonly TextGranularity Line = new("line");

    /// <summary>
    ///     A single word.
    /// </summary>
    public static readonly TextGranularity Word = new("word");

    /// <summary>
    ///     A single glyph or symbol.
    /// </summary>
    public static readonly TextGranularity Glyph = new("glyph");
