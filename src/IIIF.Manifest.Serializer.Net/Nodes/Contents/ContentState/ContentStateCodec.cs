...
public static class ContentStateCodec
{
    ...
    public static ContentState Decode(string encoded)
    {
        ...
        {
            throw new ArgumentException("Content state string cannot be null or whitespace.", nameof(encoded));
        }
        ...
        {
            throw new FormatException("Invalid content state string: incorrect length.");
        }
