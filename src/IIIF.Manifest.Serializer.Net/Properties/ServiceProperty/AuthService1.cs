...
public class AuthService1 : BaseItem<AuthService1>, IBaseService
{
    ...
    public IReadOnlyCollection<AuthService1> Services
    {
    ...
    /// </summary>
    public AuthService1 AddService(AuthService1 service)
    {
    ...
    /// </summary>
    public AuthService1 RemoveService(AuthService1 service)
    {
